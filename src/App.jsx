...
function App() {
  ...
  useEffect(() => {
    // si el objeto monedas tiene algo, entonces se ejecuta el codigo de abajo
    if (Object.keys(monedas).length > 0) {
      const cotizarCripto = async () => {
        ...
        // seteamos el resultado en el state de resultado
  ...
  return (
    <Contenedor>
      ...
      <div>
        <Heading className='App'>Cotiza tus criptomonedas al instante</Heading>
        <Formulario setMonedas={setMonedas} />
        {cargando && <Spiner />}
        {/* si el objeto resultado tiene algo, entonces se muestra el componente */}
